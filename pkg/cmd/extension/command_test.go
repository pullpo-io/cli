...
func TestNewCmdExtension(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantStdout: "pullpo test\tcli/gh-test\t1\npullpo test2\tcli/gh-test2\t1\n",
		},
		{
			...
			wantStdout: heredoc.Doc(`
				...
				Next Steps
				- run 'cd gh-test; pullpo extension install .; pullpo test' to see your new extension in action
		...
		},
		{
			...
			wantStdout: heredoc.Doc(`
				...
				Next Steps
				- run 'cd gh-test; pullpo extension install .; pullpo test' to see your new extension in action
				- run 'go build && pullpo test' to see changes in your code as you develop
				- run 'pullpo repo create' to share your extension with others
		...
		},
		{
			...
			wantStdout: heredoc.Doc(`
				...
				Next Steps
				- run 'cd gh-test; pullpo extension install .' to install your extension locally
				- fill in script/build.sh with your compilation script for automated builds
				- compile a gh-test binary locally and run 'pullpo test' to see changes
				- run 'pullpo repo create' to share your extension with others
