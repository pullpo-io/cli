...
func NewCmdBrowse(f *cmdutil.Factory, runF func(*BrowseOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			$ pullpo browse 77507cd94ccafcf568f8560cfecde965fcfa63
			#=> Open commit page

			$ pullpo browse --settings
			#=> Open repository settings

			$ pullpo browse main.go:312
			#=> Open main.go at line 312

			$ pullpo browse main.go --branch bug-fix
			#=> Open main.go with the repository at head of bug-fix branch

			$ pullpo browse main.go --commit=77507cd94ccafcf568f8560cfecde965fcfa63
