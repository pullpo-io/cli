		...
		},
		{
			...
			wantErrOut: heredoc.Doc(`
				joel.miller
				  ...
				  - To request missing scopes, run: pullpo auth refresh -h joel.miller
		...
		},
		{
			...
			wantErrOut: heredoc.Doc(`
				joel.miller
				  ...
				  - To re-authenticate, run: pullpo auth login -h joel.miller
				  - To forget about this host, run: pullpo auth logout -h joel.miller
