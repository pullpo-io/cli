...
// dialog by external pullpo CLI extensions. By default output selected codespace name
...
// ```shell
//
//	pullpo codespace select --file /tmp/selected_codespace.txt
//
// ```
