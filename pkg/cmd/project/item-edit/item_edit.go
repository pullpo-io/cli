...
func NewCmdEditItem(f *cmdutil.Factory, runF func(config editItemConfig) error) *cobra.Command {
	...
	editItemCmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			pullpo project item-edit --id <item-ID> --field-id <field-ID> --project-id <project-ID> --text "new text"

			# clear an item's field value
			pullpo project item-edit --id <item-ID> --field-id <field-ID> --project-id <project-ID> --clear
		`),
