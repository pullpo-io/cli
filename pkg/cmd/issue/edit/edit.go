...
func NewCmdEdit(f *cmdutil.Factory, runF func(*EditOptions) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		`, "`"),
		Example: heredoc.Doc(`
			$ pullpo issue edit 23 --title "I found a bug" --body "Nothing works"
			$ pullpo issue edit 23 --add-label "bug,help wanted" --remove-label "core"
			$ pullpo issue edit 23 --add-assignee "@me" --remove-assignee monalisa,hubot
			$ pullpo issue edit 23 --add-project "Roadmap" --remove-project v1,v2
			$ pullpo issue edit 23 --milestone "Version 1"
			$ pullpo issue edit 23 --body-file body.txt
			$ pullpo issue edit 23 34 --add-label "help wanted"
		`),
